...
export function TotalAmount({formData,handleChange}){
    return (
        <Accordion >
                <AccordionSummary
                    ...
                    id="panel1a-header"
                >
                    <Typography>Total Amount <span className="required">*Required</span></Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <div> {/* Use a <div> here instead of <Typography> */}
                        <FormControl variant="standard" className="margin-form-control">
                            ...
                            <Input
                                ...
                                data-id-error="totalAmount-amount"
                                value={formData.totalAmount.amount}
                                type="number"
                                aria-describedby={`component-helper-text-name`}
                                onChange={(e) => handleChange(e, 'totalAmount', -1, 'amount', 'none')}
                            />
                            <FormHelperText error id={`totalAmount-amount`} hidden>
                        ...
                        <FormControl variant="standard">
                            ...
                            <Input
                                ...
                                data-id-error="totalAmount-currency"
                                aria-describedby={`component-helper-text-category`}
                                onChange={(e) => handleChange(e, 'totalAmount', -1, 'currency', 'none')}
                            />
                            <FormHelperText error hidden id={`totalAmount-currency`}>
                                Some important helper text
                            </FormHelperText>
                        </FormControl>
                        <span className="required">*Required</span>
